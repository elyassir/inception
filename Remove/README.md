...
https://knowledge.digicert.com/general-information/enabling-tls-1-1-and-tls-1-2-on-web-browsers
...
if the protected mode in on you cannot 

# root@14ab63b82bb5:/# telnet redis 6379   # This is wordpress
# Trying 172.18.0.5...
# Connected to redis.
# Escape character is '^]'.
